...
struct FeedView: View {
    ...
    private var miniCommunityTendencies: [Tendency] = [Tendency(description: "La parada de autobús se ha convertido en basurero público", detailedDescription: "La parada de autobúas de tu manzana de acuerdo a los vecinos se ha convertido en un basurero público.", image: Image(.tendency2),votes: 60),Tendency(description: "La parada de autobús se ha convertido en basurero público", detailedDescription: "La parada de autobúas de tu manzana de acuerdo a los vecinos se ha convertido en un basurero público.", image: Image(.tendency2),votes: 60),Tendency(description: "La parada de autobús se ha convertido en basurero público", detailedDescription: "La parada de autobúas de tu manzana de acuerdo a los vecinos se ha convertido en un basurero público.", image: Image(.tendency2),votes: 60)]
